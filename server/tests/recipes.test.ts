...
describe('POST /api/v1/recipes', () => {
  ...
  it('should handle server errors', async () => {
    ...
    const createRecipeStub = sinon.stub(RecipeService.prototype, 'addRecipe').throws(new Error('Database Error'));
...
describe('PUT /api/v1/recipes/:id', () => {
  ...
  it('should handle server errors', async () => {
    ...
    const updateRecipeStub = sinon.stub(RecipeService.prototype, 'updateRecipe').throws(new Error('Database Error'));
...
describe('GET /api/v1/recipes/:id', () => {
  ...
  it('should return 404 if recipe not found', async () => {
    ...
    expect(response.body).toEqual({ message: 'Recipe with given ID not found' });
  });
...
describe('DELETE /api/v1/recipes/:id', () => {
  it('should delete a recipe', async () => {
    ...
    const deleteRecipeStub = sinon.stub(RecipeService.prototype, 'deleteRecipe').resolves();
  ...
  it('should return 404 if recipe not found', async () => {
    ...
    const deleteRecipeStub = sinon.stub(RecipeService.prototype, 'deleteRecipe').throws(new FirebaseError('Recipe does not exist', 404));
  ...
  it('should handle server errors', async () => {
    ...
    const deleteRecipeStub = sinon.stub(RecipeService.prototype, 'deleteRecipe').throws(new Error('Database Error'));
